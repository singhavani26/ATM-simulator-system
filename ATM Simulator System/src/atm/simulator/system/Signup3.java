...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(){
        ...
        l3.setFont(new Font("Raleway", Font.BOLD, 18));
         ...
         l4 = new JLabel(" XXXX_XXXX_XXXX_4184");
        l4.setFont(new Font("Raleway", Font.BOLD, 18));
        
         l5 = new JLabel(" (your 16 digit card no.)");
        l5.setFont(new Font("Raleway", Font.BOLD, 18));
        
         l6 = new JLabel(" It would appear on ATM card/cheque books and statements");
        ...
        c7=new JCheckBox("I hereby declares that the6above entered details correct to the best of my knowledge,", true);
